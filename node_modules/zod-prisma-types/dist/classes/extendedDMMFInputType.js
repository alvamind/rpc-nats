...
const SPLIT_NAME_REGEX = /Unchecked|Create|Update|CreateMany|CreateManyAndReturn|UpdateMany|Upsert|Where|WhereUnique|OrderBy|ScalarWhere|Aggregate|GroupBy/g;
class ExtendedDMMFInputType extends formattedNames_1.FormattedNames {
    ...
    _setImports() {
        ...
        if (this._fieldIsPrismaFunctionType() && ((_a = this.linkedModel) === null || _a === void 0 ? void 0 : _a.fieldImports)) {
